-- Migration: Update generate_coaching_sessions to accept start_date parameter
-- Step 1: Drop the old function (specify the exact signature)
DROP FUNCTION IF EXISTS generate_coaching_sessions(INTEGER);

-- Step 2: Create the new function with both parameters
